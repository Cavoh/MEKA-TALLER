...
export function ReportControlBar({
  ...
  return (
    <div className="flex items-center justify-start gap-4 bg-[var(--modal-bg)] p-2 rounded-[40px] border border-[var(--border-main)] card-shadow overflow-x-auto no-scrollbar mb-8">
